...
const AllService = ({ users, searchTerm, currentPage, setCurrentPage }) => {
     ...
     <>
                    ...
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        <button 
                          ...
                          title="View Details"
                        >
                         <Link to='/update-cate'> <Edit className="w-4 h-4" /></Link>
                        </button>

                        <button 
                          className="w-8 h-8 bg-red-200 text-red-600 rounded-md flex items-center justify-center transition-colors cursor-pointer"
                          title="More Options"
                        >
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="text-sm text-gray-500">
          ...
          {Math.min(startIndex + 10, filteredUsers.length)} of {filteredUsers.length} results
        </div>
