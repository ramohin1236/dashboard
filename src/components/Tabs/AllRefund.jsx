...
const AllRefund = ({ processedRefunds, searchTerm, currentPage, setCurrentPage }) => {
      const [selectedRefund, setSelectedRefund] = useState(null);
  const [isModalOpen, setIsModalOpen] = useState(false);

  const filteredRefunds = processedRefunds.filter(refund => 
  ...
  return (
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="text-sm text-gray-500">
          ...
          {Math.min(startIndex + 10, filteredRefunds.length)} of {filteredRefunds.length} processed refunds
        </div>
